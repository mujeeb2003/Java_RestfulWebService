...
//    Post example for inserting customers
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public String insertCustomer(@QueryParam("id") int id,@QueryParam("name") String name,@QueryParam("email") String email) throws ClassNotFoundException, SQLException{
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public String updateCustomers(@QueryParam("id") int id,@QueryParam("name") String name,@QueryParam("email") String email) throws ClassNotFoundException, SQLException{
